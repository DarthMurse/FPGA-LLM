...
// Decode control shell.
// Responsibilities:
// - accept one-token decode commands and embedding payloads
// - sequence decode execution across all layers
// - return final hidden-state payload to host_if
